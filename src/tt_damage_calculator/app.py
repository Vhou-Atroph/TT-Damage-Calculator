...
### Keybinds
window.bind('<' + window.settings.keybinds.defense + '>', lambda par: [window.buff_defense.set(tt_damage_calculator.advance_float([0.0,0.1,0.15,0.2,0.25], window.buff_defense.get())), calc_dmg()])
window.bind('<' + window.settings.keybinds.negative_defense + '>', lambda par: [window.debuff_defense.set(tt_damage_calculator.advance_float([0.0,0.2,0.4,0.5,0.6], window.debuff_defense.get())), calc_dmg()])
window.bind('<' + window.settings.keybinds.lure + '>', lambda par: [window.lure.set(tt_damage_calculator.toggleswap(window.lure.get())), calc_dmg()])
window.bind('<' + window.settings.keybinds.lock + '>', lambda par: [status_lock.set(tt_damage_calculator.toggleswap(status_lock.get())), calc_dmg()])
window.bind('<' + window.settings.keybinds.pin + '>', lambda par: [window.pinned.set(tt_damage_calculator.toggleswap(window.pinned.get())), window.pin()])
...
window.bind('<' + window.settings.keybinds.organic + '>', organic_toggle)
...
window.bind('<' + window.settings.keybinds.reset + '>', clear_inputs)
...
program_menu.add_command(label="Settings", command=lambda:webbrowser.open(window.asset_path + "/assets/window.settings.toml"))
program_menu.add_checkbutton(label="Pin window", command=window.pin, variable=window.pinned, onvalue=True, offvalue=False, accelerator=window.settings.keybinds.pin)
program_menu.add_command(label="Check for update", command=lambda:update_checker.compare_versions(window.asset_path + "/assets/version.txt"))
...
calculations_menu.add_checkbutton(label="Lock Status", variable=status_lock, onvalue=True, offvalue=False, accelerator=window.settings.keybinds.lock)
