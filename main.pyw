...
bike_horn.configure(command=lambda:gag_btn(bike_horn.gag,snd_used,bike_horn))
whistle.configure(command=lambda:gag_btn(whistle.gag,snd_used,whistle))
bugle.configure(command=lambda:gag_btn(bugle.gag,snd_used,bugle))
aoogah.configure(command=lambda:gag_btn(aoogah.gag,snd_used,aoogah))
elephant_trunk.configure(command=lambda:gag_btn(elephant_trunk.gag,snd_used,elephant_trunk))
fog_horn.configure(command=lambda:gag_btn(fog_horn.gag,snd_used,fog_horn))
opera_singer.configure(command=lambda:gag_btn(opera_singer.gag,snd_used,opera_singer))
#Throw
...
cupcake.configure(command=lambda:gag_btn(cupcake.gag,trw_used,cupcake))
fruit_pie_slice.configure(command=lambda:gag_btn(fruit_pie_slice.gag,trw_used,fruit_pie_slice))
cream_pie_slice.configure(command=lambda:gag_btn(cream_pie_slice.gag,trw_used,cream_pie_slice))
whole_fruit_pie.configure(command=lambda:gag_btn(whole_fruit_pie.gag,trw_used,whole_fruit_pie))
whole_cream_pie.configure(command=lambda:gag_btn(whole_cream_pie.gag,trw_used,whole_cream_pie))
birthday_cake.configure(command=lambda:gag_btn(birthday_cake.gag,trw_used,birthday_cake))
wedding_cake.configure(command=lambda:gag_btn(wedding_cake.gag,trw_used,wedding_cake))
#Squirt
...
squirting_flower.configure(command=lambda:gag_btn(squirting_flower.gag,sqt_used,squirting_flower))
water_glass.configure(command=lambda:gag_btn(water_glass.gag,sqt_used,water_glass))
squirt_gun.configure(command=lambda:gag_btn(squirt_gun.gag,sqt_used,squirt_gun))
seltzer_bottle.configure(command=lambda:gag_btn(seltzer_bottle.gag,sqt_used,seltzer_bottle))
fire_hose.configure(command=lambda:gag_btn(fire_hose.gag,sqt_used,fire_hose))
storm_cloud.configure(command=lambda:gag_btn(storm_cloud.gag,sqt_used,storm_cloud))
geyser.configure(command=lambda:gag_btn(geyser.gag,sqt_used,geyser))
#Drop
...
flower_pot.configure(command=lambda:gag_btn(flower_pot.gag,drp_used,flower_pot))
sandbag.configure(command=lambda:gag_btn(sandbag.gag,drp_used,sandbag))
anvil.configure(command=lambda:gag_btn(anvil.gag,drp_used,anvil))
big_weight.configure(command=lambda:gag_btn(big_weight.gag,drp_used,big_weight))
safe.configure(command=lambda:gag_btn(safe.gag,drp_used,safe))
grand_piano.configure(command=lambda:gag_btn(grand_piano.gag,drp_used,grand_piano))
toontanic.configure(command=lambda:gag_btn(toontanic.gag,drp_used,toontanic))
#Trap!
...
banana_peel.configure(command=lambda:gag_btn(banana_peel.gag,trp_used,banana_peel))
rake.configure(command=lambda:gag_btn(rake.gag,trp_used,rake))
marbles.configure(command=lambda:gag_btn(marbles.gag,trp_used,marbles))
quicksand.configure(command=lambda:gag_btn(quicksand.gag,trp_used,quicksand))
trapdoor.configure(command=lambda:gag_btn(trapdoor.gag,trp_used,trapdoor))
tnt.configure(command=lambda:gag_btn(tnt.gag,trp_used,tnt))
railroad.configure(command=lambda:gag_btn(railroad.gag,trp_used,railroad))
