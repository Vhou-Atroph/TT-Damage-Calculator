...
banana_peel = GagButton(trp_frame, image=banana_peel_img, gag=rustygag.Gag("Gag", "Banana Peel", "Trap", 0, 12))
rake_img = PhotoImage(file=asset_path + '/assets/img/rake.png')
rake = GagButton(trp_frame, image=rake_img, gag=rustygag.Gag("Gag", "Rake", "Trap", 1, 18))
marbles_img = PhotoImage(file=asset_path + '/assets/img/marbles.png')
marbles = GagButton(trp_frame, image=marbles_img, gag=rustygag.Gag("Gag", "Marbles", "Trap", 2, 35))
quicksand_img = PhotoImage(file=asset_path + '/assets/img/quicksand.png')
quicksand = GagButton(trp_frame, image=quicksand_img, gag=rustygag.Gag("Gag", "Quicksand", "Trap", 3, 50))
trapdoor_img = PhotoImage(file=asset_path + '/assets/img/trapdoor.png')
trapdoor = GagButton(trp_frame, image=trapdoor_img, gag=rustygag.Gag("Gag", "Trapdoor", "Trap", 4, 85))
tnt_img = PhotoImage(file=asset_path + '/assets/img/tnt.png')
tnt = GagButton(trp_frame, image=tnt_img, gag=rustygag.Gag("Gag", "TNT", "Trap", 5, 180))
