...
bike_horn=GagButton(snd_frame,image=bike_horn_img,gag=tt_gags.Gag("Gag","Bike Horn",snd_used,0,4))
whistle_img=PhotoImage(file='img/whistle.png')
whistle=GagButton(snd_frame,image=whistle_img,gag=tt_gags.Gag("Gag","Whistle",snd_used,1,7))
bugle_img=PhotoImage(file='img/bugle.png')
bugle=GagButton(snd_frame,image=bugle_img,gag=tt_gags.Gag("Gag","Bugle",snd_used,2,11))
aoogah_img=PhotoImage(file='img/aoogah.png')
aoogah=GagButton(snd_frame,image=aoogah_img,gag=tt_gags.Gag("Gag","Aoogah",snd_used,3,16))
elephant_trunk_img=PhotoImage(file='img/elephant-trunk.png')
elephant_trunk=GagButton(snd_frame,image=elephant_trunk_img,gag=tt_gags.Gag("Gag","Elephant Trunk",snd_used,4,21))
fog_horn_img=PhotoImage(file='img/fog-horn.png')
fog_horn=GagButton(snd_frame,image=fog_horn_img,gag=tt_gags.Gag("Gag","Fog Horn",snd_used,5,50))
opera_singer_img=PhotoImage(file='img/opera-singer.png')
opera_singer=GagButton(snd_frame,image=opera_singer_img,gag=tt_gags.Gag("Gag","Opera Singer",snd_used,6,90))
bike_horn.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Bike Horn",snd_used,0,4),snd_used,bike_horn))
whistle.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Whistle",snd_used,1,7),snd_used,whistle))
bugle.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Bugle",snd_used,2,11),snd_used,bugle))
aoogah.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Aoogah",snd_used,3,16),snd_used,aoogah))
elephant_trunk.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Elephant Trunk",snd_used,4,21),snd_used,elephant_trunk))
fog_horn.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Fog Horn",snd_used,5,50),snd_used,fog_horn))
opera_singer.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Opera Singer",snd_used,6,90),snd_used,opera_singer))
#Throw
trw_frame=Frame(gag_frame)
cupcake_img=PhotoImage(file='img/cupcake.png')
cupcake=GagButton(trw_frame,image=cupcake_img,gag=tt_gags.Gag("Gag","Cupcake",trw_used,0,6))
fruit_pie_slice_img=PhotoImage(file='img/fruit-pie-slice.png')
fruit_pie_slice=GagButton(trw_frame,image=fruit_pie_slice_img,gag=tt_gags.Gag("Gag","Fruit Pie Slice",trw_used,1,10))
cream_pie_slice_img=PhotoImage(file='img/cream-pie-slice.png')
cream_pie_slice=GagButton(trw_frame,image=cream_pie_slice_img,gag=tt_gags.Gag("Gag","Cream Pie Slice",trw_used,2,17))
whole_fruit_pie_img=PhotoImage(file='img/whole-fruit-pie.png')
whole_fruit_pie=GagButton(trw_frame,image=whole_fruit_pie_img,gag=tt_gags.Gag("Gag","Whole Fruit Pie",trw_used,3,27))
whole_cream_pie=GagButton(trw_frame,image=whole_cream_pie_img,gag=tt_gags.Gag("Gag","Whole Cream Pie",trw_used,4,40))
birthday_cake_img=PhotoImage(file='img/birthday-cake.png')
birthday_cake=GagButton(trw_frame,image=birthday_cake_img,gag=tt_gags.Gag("Gag","Birthday Cake",trw_used,5,100))
wedding_cake_img=PhotoImage(file='img/wedding-cake.png')
wedding_cake=GagButton(trw_frame,image=wedding_cake_img,gag=tt_gags.Gag("Gag","Wedding Cake",trw_used,6,120))
cupcake.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Cupcake",trw_used,0,6),trw_used,cupcake))
fruit_pie_slice.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Fruit Pie Slice",trw_used,1,10),trw_used,fruit_pie_slice))
cream_pie_slice.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Cream Pie Slice",trw_used,2,17),trw_used,cream_pie_slice))
whole_fruit_pie.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Whole Fruit Pie",trw_used,3,27),trw_used,whole_fruit_pie))
whole_cream_pie.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Whole Cream Pie",trw_used,4,40),trw_used,whole_cream_pie))
birthday_cake.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Birthday Cake",trw_used,5,100),trw_used,birthday_cake))
wedding_cake.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Wedding Cake",trw_used,6,120),trw_used,wedding_cake))
#Squirt
sqt_frame=Frame(gag_frame)
squirting_flower_img=PhotoImage(file='img/squirting-flower.png')
squirting_flower=GagButton(sqt_frame,image=squirting_flower_img,gag=tt_gags.Gag("Gag","Squirting Flower",sqt_used,0,4))
water_glass_img=PhotoImage(file='img/glass-of-water.png')
water_glass=GagButton(sqt_frame,image=water_glass_img,gag=tt_gags.Gag("Gag","Glass of Water",sqt_used,1,8))
squirt_gun_img=PhotoImage(file='img/squirt-gun.png')
squirt_gun=GagButton(sqt_frame,image=squirt_gun_img,gag=tt_gags.Gag("Gag","Squirt Gun",sqt_used,2,12))
seltzer_bottle_img=PhotoImage(file='img/seltzer-bottle.png')
seltzer_bottle=GagButton(sqt_frame,image=seltzer_bottle_img,gag=tt_gags.Gag("Gag","Seltzer Bottle",sqt_used,3,21))
fire_hose_img=PhotoImage(file='img/fire-hose.png')
fire_hose=GagButton(sqt_frame,image=fire_hose_img,gag=tt_gags.Gag("Gag","Fire Hose",sqt_used,4,30))
storm_cloud_img=PhotoImage(file='img/storm-cloud.png')
storm_cloud=GagButton(sqt_frame,image=storm_cloud_img,gag=tt_gags.Gag("Gag","Storm Cloud",sqt_used,5,80))
geyser_img=PhotoImage(file='img/geyser.png')
geyser=GagButton(sqt_frame,image=geyser_img,gag=tt_gags.Gag("Gag","Geyser",sqt_used,6,105))
squirting_flower.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Squirting Flower",sqt_used,0,4),sqt_used,squirting_flower))
water_glass.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Glass of Water",sqt_used,1,8),sqt_used,water_glass))
squirt_gun.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Squirt Gun",sqt_used,2,12),sqt_used,squirt_gun))
seltzer_bottle.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Seltzer Bottle",sqt_used,3,21),sqt_used,seltzer_bottle))
fire_hose.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Fire Hose",sqt_used,4,30),sqt_used,fire_hose))
storm_cloud.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Storm Cloud",sqt_used,5,80),sqt_used,storm_cloud))
geyser.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Geyser",sqt_used,6,105),sqt_used,geyser))
#Drop
drp_frame=Frame(gag_frame)
flower_pot_img=PhotoImage(file='img/flower-pot.png')
flower_pot=GagButton(drp_frame,image=flower_pot_img,gag=tt_gags.Gag("Gag","Flower Pot",drp_used,0,10))
sandbag_img=PhotoImage(file='img/sandbag.png')
sandbag=GagButton(drp_frame,image=sandbag_img,gag=tt_gags.Gag("Gag","Sandbag",drp_used,1,18))
anvil_img=PhotoImage(file='img/anvil.png')
anvil=GagButton(drp_frame,image=anvil_img,gag=tt_gags.Gag("Gag","Anvil",drp_used,2,30))
big_weight_img=PhotoImage(file='img/big-weight.png')
big_weight=GagButton(drp_frame,image=big_weight_img,gag=tt_gags.Gag("Gag","Big Weight",drp_used,3,45))
safe_img=PhotoImage(file='img/safe.png')
safe=GagButton(drp_frame,image=safe_img,gag=tt_gags.Gag("Gag","Safe",drp_used,4,70))
grand_piano_img=PhotoImage(file='img/grand-piano.png')
grand_piano=GagButton(drp_frame,image=grand_piano_img,gag=tt_gags.Gag("Gag","Grand Piano",drp_used,5,170))
toontanic_img=PhotoImage(file='img/toontanic.png')
toontanic=GagButton(drp_frame,image=toontanic_img,gag=tt_gags.Gag("Gag","Toontanic",drp_used,6,180))
flower_pot.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Flower Pot",drp_used,0,10),drp_used,flower_pot))
sandbag.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Sandbag",drp_used,1,18),drp_used,sandbag))
anvil.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Anvil",drp_used,2,30),drp_used,anvil))
big_weight.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Big Weight",drp_used,3,45),drp_used,big_weight))
safe.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Safe",drp_used,4,70),drp_used,safe))
grand_piano.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Grand Piano",drp_used,5,170),drp_used,grand_piano))
toontanic.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Toontanic",drp_used,6,180),drp_used,toontanic))
#Trap!
trpFrame=Frame(gag_frame)
banana_peel_img=PhotoImage(file='img/banana-peel.png')
banana_peel=GagButton(trpFrame,image=banana_peel_img,gag=tt_gags.Gag("Gag","Banana Peel",trp_used,0,12))
rake_img=PhotoImage(file='img/rake.png')
rake=GagButton(trpFrame,image=rake_img,gag=tt_gags.Gag("Gag","Rake",trp_used,1,18))
marbles_img=PhotoImage(file='img/marbles.png')
marbles=GagButton(trpFrame,image=marbles_img,gag=tt_gags.Gag("Gag","Marbles",trp_used,2,35))
quicksand_img=PhotoImage(file='img/quicksand.png')
quicksand=GagButton(trpFrame,image=quicksand_img,gag=tt_gags.Gag("Gag","Quicksand",trp_used,3,50))
trapdoor_img=PhotoImage(file='img/trapdoor.png')
trapdoor=GagButton(trpFrame,image=trapdoor_img,gag=tt_gags.Gag("Gag","Trapdoor",trp_used,4,85))
tnt_img=PhotoImage(file='img/tnt.png')
tnt=GagButton(trpFrame,image=tnt_img,gag=tt_gags.Gag("Gag","TNT",trp_used,5,180))
railroad_img=PhotoImage(file='img/railroad.png')
railroad=GagButton(trpFrame,image=railroad_img,gag=tt_gags.Gag("Gag","Railroad",trp_used,6,200))
banana_peel.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Banana Peel",trp_used,0,12),trp_used,banana_peel))
rake.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Rake",trp_used,1,18),trp_used,rake))
marbles.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Marbles",trp_used,2,35),trp_used,marbles))
quicksand.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Quicksand",trp_used,3,50),trp_used,quicksand))
trapdoor.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Trapdoor",trp_used,4,85),trp_used,trapdoor))
tnt.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","TNT",trp_used,5,180),trp_used,tnt))
railroad.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Railroad",trp_used,6,200),trp_used,railroad))
