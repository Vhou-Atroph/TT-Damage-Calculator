...
settings = rustygag.Settings("assets/settings.toml")
...
birthday_cake_img=PhotoImage(file='assets/img/birthday-cake.png')
birthday_cake=GagButton(trw_frame,image=birthday_cake_img,gag=rustygag.Gag("Gag","Birthday Cake","Throw",5,100))
wedding_cake_img=PhotoImage(file='assets/img/wedding-cake.png')
...
program_menu.add_command(label="Check for update",command=lambda:update_checker.compare_versions("assets/version.txt"))
