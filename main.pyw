...
bike_horn=GagButton(snd_frame,image=bike_horn_img)
whistle_img=PhotoImage(file='img/whistle.png')
whistle=GagButton(snd_frame,image=whistle_img)
...
aoogah=GagButton(snd_frame,image=aoogah_img)
elephant_trunk_img=PhotoImage(file='img/elephant-trunk.png')
elephant_trunk=GagButton(snd_frame,image=elephant_trunk_img)
fog_horn_img=PhotoImage(file='img/fog-horn.png')
fog_horn=GagButton(snd_frame,image=fog_horn_img)
opera_singer_img=PhotoImage(file='img/opera-singer.png')
opera_singer=GagButton(snd_frame,image=opera_singer_img)
...
elephant_trunk.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Elephant Trunk",4,snd_used,21),snd_used,elephant_trunk))
fog_horn.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Fog Horn",snd_used,5,50),snd_used,fog_horn))
opera_singer.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Opera Singer",6,snd_used,90),snd_used,opera_singer))
#Throw
trw_frame=Frame(gag_frame)
cupcake_img=PhotoImage(file='img/cupcake.png')
cupcake=GagButton(trw_frame,image=cupcake_img)
fruit_pie_slice_img=PhotoImage(file='img/fruit-pie-slice.png')
fruit_pie_slice=GagButton(trw_frame,image=fruit_pie_slice_img)
cream_pie_slice_img=PhotoImage(file='img/cream-pie-slice.png')
cream_pie_slice=GagButton(trw_frame,image=cream_pie_slice_img)
whole_fruit_pie_img=PhotoImage(file='img/whole-fruit-pie.png')
whole_fruit_pie=GagButton(trw_frame,image=whole_fruit_pie_img)
whole_cream_pie=GagButton(trw_frame,image=whole_cream_pie_img)
birthday_cake_img=PhotoImage(file='img/birthday-cake.png')
birthday_cake=GagButton(trw_frame,image=birthday_cake_img)
wedding_cake_img=PhotoImage(file='img/wedding-cake.png')
wedding_cake=GagButton(trw_frame,image=wedding_cake_img)
...
squirting_flower=GagButton(sqt_frame,image=squirting_flower_img)
water_glass_img=PhotoImage(file='img/glass-of-water.png')
water_glass=GagButton(sqt_frame,image=water_glass_img)
squirt_gun_img=PhotoImage(file='img/squirt-gun.png')
squirt_gun=GagButton(sqt_frame,image=squirt_gun_img)
seltzer_bottle_img=PhotoImage(file='img/seltzer-bottle.png')
seltzer_bottle=GagButton(sqt_frame,image=seltzer_bottle_img)
fire_hose_img=PhotoImage(file='img/fire-hose.png')
fire_hose=GagButton(sqt_frame,image=fire_hose_img)
storm_cloud_img=PhotoImage(file='img/storm-cloud.png')
storm_cloud=GagButton(sqt_frame,image=storm_cloud_img)
geyser_img=PhotoImage(file='img/geyser.png')
geyser=GagButton(sqt_frame,image=geyser_img)
...
flower_pot=GagButton(drp_frame,image=flower_pot_img)
sandbag_img=PhotoImage(file='img/sandbag.png')
sandbag=GagButton(drp_frame,image=sandbag_img)
anvil_img=PhotoImage(file='img/anvil.png')
anvil=GagButton(drp_frame,image=anvil_img)
big_weight_img=PhotoImage(file='img/big-weight.png')
big_weight=GagButton(drp_frame,image=big_weight_img)
safe_img=PhotoImage(file='img/safe.png')
safe=GagButton(drp_frame,image=safe_img)
grand_piano_img=PhotoImage(file='img/grand-piano.png')
grand_piano=GagButton(drp_frame,image=grand_piano_img)
toontanic_img=PhotoImage(file='img/toontanic.png')
toontanic=GagButton(drp_frame,image=toontanic_img)
...
grand_piano.configure(command=lambda:gag_btn(tt_gags.Gag("Gag","Piano",drp_used,5,170),drp_used,grand_piano))
...
banana_peel=GagButton(trpFrame,image=banana_peel_img)
rake_img=PhotoImage(file='img/rake.png')
rake=GagButton(trpFrame,image=rake_img)
marbles_img=PhotoImage(file='img/marbles.png')
marbles=GagButton(trpFrame,image=marbles_img)
quicksand_img=PhotoImage(file='img/quicksand.png')
quicksand=GagButton(trpFrame,image=quicksand_img)
trapdoor_img=PhotoImage(file='img/trapdoor.png')
trapdoor=GagButton(trpFrame,image=trapdoor_img)
tnt_img=PhotoImage(file='img/tnt.png')
tnt=GagButton(trpFrame,image=tnt_img)
railroad_img=PhotoImage(file='img/railroad.png')
railroad=GagButton(trpFrame,image=railroad_img)
